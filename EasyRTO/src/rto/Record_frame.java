 ...
 * Record_frame.java
 *
 * Created on 7 Oct, 2012, 11:17:06 AM
 */
package rto;
 ...
 * @author Bhupesh
 */
public class Record_frame extends javax.swing.JFrame {

    /** Creates new form Record_frame */
    public Record_frame() {
    initComponents();
    ...
    try {
           ...
           String sql="Select Lic_no from record";
                ...
                while(rs.next())
                {
                    ...
                    if(typed.equals(l))
                    {
                        DataRec obj=new DataRec(lic_id.getText());
        obj.setVisible(true); 
                    }
                }
...
close();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Record_frame().setVisible(true);
            }
        });
    }
